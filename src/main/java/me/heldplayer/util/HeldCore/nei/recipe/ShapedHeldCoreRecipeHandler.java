...
public class ShapedHeldCoreRecipeHandler extends TemplateRecipeHandler {
    ...
    public class CachedShapedRecipe extends CachedRecipe {
        ...
        public CachedShapedRecipe(ShapedHeldCoreRecipe recipe) {
            this.recipe = recipe;
        ...
        public void setIngredients(int width, int height, List<ItemStack>[] items) {
            ...
            this.getCycledIngredients(ShapedHeldCoreRecipeHandler.this.cycleticks / 20, this.ingredients);
    ...
    public String getRecipeName() {
        return NEIClientUtils.translate("recipe.shaped.heldcore");
    }

    @Override
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals("crafting") && this.getClass() == ShapedHeldCoreRecipeHandler.class) {
            List<IRecipe> allrecipes = CraftingManager.getInstance().getRecipeList();
            for (IRecipe irecipe : allrecipes) {
                CachedShapedRecipe recipe = null;
                if (irecipe instanceof ShapedHeldCoreRecipe) {
                    recipe = new CachedShapedRecipe((ShapedHeldCoreRecipe) irecipe);
                }
                if (recipe == null) {
                    continue;
                }
