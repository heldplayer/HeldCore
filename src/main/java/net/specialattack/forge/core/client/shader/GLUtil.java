...
public final class GLUtil {
    ...
    public static void initialize() {
        ...
        SHADERS_SUPPORTED = capabilities.OpenGL21 || capabilities.GL_ARB_vertex_shader && capabilities.GL_ARB_fragment_shader && capabilities.GL_ARB_shader_objects;
    ...
    public static int createVertexShader() {
        if (SHADERS_SUPPORTED) {
            if (ARB_SHADING) {
                return ARBShaderObjects.glCreateShaderObjectARB(GL_VERTEX_SHADER);
            } else {
                return GL20.glCreateShader(GL_VERTEX_SHADER);
            }
        }
        return -1;
    }
    ...
    public static int createFragmentShader() {
        if (SHADERS_SUPPORTED) {
            if (ARB_SHADING) {
                return ARBShaderObjects.glCreateShaderObjectARB(GL_FRAGMENT_SHADER);
            } else {
                return GL20.glCreateShader(GL_FRAGMENT_SHADER);
            }
        }
        return -1;
    }
