...
public class SpACoreWorldData extends WorldSavedData {
    ...
    public static SpACoreWorldData getData(World world) {
        SpACoreWorldData result = (SpACoreWorldData) world.perWorldStorage.loadData(SpACoreWorldData.class, SpACoreWorldData.key);
        if (result == null) {
            result = new SpACoreWorldData();
            result.fillInDefaults();
            world.perWorldStorage.setData(SpACoreWorldData.key, result);
        }
        return result;
    }
